 ...
 * RestController ganerates and manages REST data.*/
/*
...
public class ProductRestController {
 ...
 // @RequestBody annotation automatically deserializes the JSON into a Java type
  ...
  //In Postman - POST - http://localhost:8085/ims/api/products/7
  ...
  //In Postman - POST - http://localhost:8085/ims/api/products/6
    //Body- Raw - Json - Enter Json Object - send
